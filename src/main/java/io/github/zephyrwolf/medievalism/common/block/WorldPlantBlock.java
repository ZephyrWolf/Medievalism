...
public class WorldPlantBlock extends Block
{
    VoxelShape shape;

    public WorldPlantBlock(Properties properties, VoxelShape shape)
    {
        super(properties);
        this.shape = shape;
    }
    ...
    public static class BasicWorldPlantBlock extends WorldPlantBlock
    {
        public BasicWorldPlantBlock(Properties props)
        {
            super(props, Shapes.block());
        }
    }
}
