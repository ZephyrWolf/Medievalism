package io.github.zephyrwolf.medievalism.registration.item;
...
public final class ItemRegistration {
    ...
    public static final DeferredItem<Item> WET_DAUB = ITEMS.registerSimpleItem("wet_daub", new Item.Properties());
