...
public final class BaseMalleableRecipeProvider {
    ...
    private static void malleableMaterialRecipes(RecipeOutput recipeOutput) {
        MalleableMaterialRecipeBuilder.builder(Ingredient.of(ItemTagCatalog.CLAY_BALL), MalleableMaterialRegistration.CLAY.get())
                ...
                .unlockedBy("stone_bench", InventoryChangeTrigger.TriggerInstance.hasItems(
                        BlockItemRegistration.STONE_BENCH
                ))
    ...
    private static void knappingRecipes(RecipeOutput recipeOutput) {
        ...
        MalleableRecipeBuilder.builder(MalleableMaterialRegistration.STONE.get(), new ItemStack(ItemRegistration.LUNATE.get()))
                ...
                .pattern("xx")
                .pattern("xx")
                .unlockedBy("stone_bench", RecipeTools.itemPredicateOf(BlockItemRegistration.STONE_BENCH))
    ...
    private static void potteryRecipes(RecipeOutput recipeOutput) {
        ...
        MalleableRecipeBuilder.builder(MalleableMaterialRegistration.CLAY.get(), new ItemStack(BlockItemRegistration.WET_GATHERERS_JAR.get()))
                .pattern("x x")
                .pattern("x x")
                .pattern(" x ")
                .unlockedBy("stone_bench", InventoryChangeTrigger.TriggerInstance.hasItems(
        ...
        MalleableRecipeBuilder.builder(MalleableMaterialRegistration.CLAY.get(), new ItemStack(BlockItemRegistration.WET_KEEPERS_CROCK.get()))
                .pattern("x  x")
                .pattern("x  x")
                .pattern("x  x")
                .pattern(" xx ")
        ...
        MalleableRecipeBuilder.builder(MalleableMaterialRegistration.CLAY.get(), new ItemStack(BlockItemRegistration.WET_SETTLERS_POT.get()))
                .pattern("x   x")
                .pattern("x   x")
                .pattern("x   x")
                .pattern("x   x")
        ...
        MalleableRecipeBuilder.builder(MalleableMaterialRegistration.CLAY.get(), new ItemStack(BlockItemRegistration.WET_CLAY_COOKING_POT.get()))
                .pattern("x   x")
                .pattern("x   x")
                .pattern(" xxx ")
                .unlockedBy("stone_bench", InventoryChangeTrigger.TriggerInstance.hasItems(
        ...
        MalleableRecipeBuilder.builder(MalleableMaterialRegistration.CLAY.get(), new ItemStack(BlockItemRegistration.WET_CLAY_CAULDRON.get()))
                .pattern("x   x")
                .pattern("x   x")
                .pattern("x   x")
                .pattern("x   x")
        ...
        MalleableRecipeBuilder.builder(MalleableMaterialRegistration.CLAY.get(), new ItemStack(BlockItemRegistration.WET_JUG.get()))
                .pattern(" x x ")
                .pattern(" x x ")
                .pattern("x   x")
                .pattern("x   x")
                ...
                .save(recipeOutput, MedievalismConstants.resource("wet_jug"));
        MalleableRecipeBuilder.builder(MalleableMaterialRegistration.CLAY.get(), new ItemStack(BlockItemRegistration.WET_FLOWER_POT.get()))
                .pattern("x x")
                .pattern(" x ")
                .unlockedBy("stone_bench", InventoryChangeTrigger.TriggerInstance.hasItems(
                        BlockItemRegistration.STONE_BENCH
                ))
                .save(recipeOutput, MedievalismConstants.resource("wet_flower_pot"));
        MalleableRecipeBuilder.builder(MalleableMaterialRegistration.CLAY.get(), new ItemStack(BlockItemRegistration.WET_DECORATED_POT.get()))
                .pattern(" xx ")
                .pattern("x  x")
                .pattern("x  x")
                .pattern(" xx ")
                ...
                .save(recipeOutput, MedievalismConstants.resource("wet_decorated_pot"));
    }
}
